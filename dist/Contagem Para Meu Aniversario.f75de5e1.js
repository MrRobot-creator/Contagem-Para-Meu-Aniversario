...
if (Date.now() > targetDate) targetDate = new Date(new Date().getFullYear() + 1, 8, 28).getTime();
...
const countdownFunction = setInterval(function() {
    ...
    if (distance < 0) {
        ...
        document.querySelector(".countdown").innerHTML = "<div class='message'><p class='message__text'>Feliz Anivers\xe1rio!</p></div>";
    }
}, 1000);
...
//# sourceMappingURL=Contagem Para Meu Aniversario.f75de5e1.js.map
